...
public class DashboardRecyclerAdapter extends RecyclerView.Adapter<DashboardRecyclerAdapter.ViewHolder> {
    private ArrayList<DashboardRecyclerItem> mData;

    // 생성자에서 데이터 리스트 객체를 전달받음.
    DashboardRecyclerAdapter(ArrayList<DashboardRecyclerItem> list) {
        mData = list;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        DashboardRecyclerItem item = mData.get(position);
