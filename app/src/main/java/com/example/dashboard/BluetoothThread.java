...
import static com.example.iaq.Bluetooth.BluetoothAPI.byteArrayToHexString;
...
public class BluetoothThread extends Thread {
        ...
        try {
          ...
          if(readBufferPosition > MINIMUM_LENGTH) {
            ...
            if (Arrays.equals(ETX, exitPoint)) {
              ...
              // 수신 받은 메시지
              recvData = byteArrayToHexString(encodedBytes);
              // 수신 메시지 전달
  ...
  public void writeHex(byte[] hex) {
    try {
      ...
      Log.e(TAG, "Send message (String) : " + byteArrayToHexString(hex));
